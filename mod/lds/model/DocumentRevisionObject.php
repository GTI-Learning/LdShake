...
class DocumentRevisionObject extends ElggObject
{
 
	protected function initialise_attributes()
	{	
		parent::initialise_attributes();
		$this->attributes['subtype'] = 'LdS_document_revision';
	}
	
	//We should not instanitate revisions. We should use createRevisionFromDocument instead.
	...
	public static function createRevisionFromDocument ($document)
	{
		$revision = new DocumentRevisionObject($document->guid);
...
function DocumentRevisionObject_init() {
   register_entity_type('object', 'LdS_document_revision');
   ...
   add_subtype('object', 'LdS_document_revision', 'DocumentRevisionObject');
}
 
register_elgg_event_handler('init', 'system', 'DocumentRevisionObject_init');